...
namespace Kista {
	...
	public class EntityRepositoryPostgresTestSuite : RepositoryTestSuite<DbPerson, Guid, DbRelationship> {
		private readonly PostgresTestConnection postgres;

		public EntityRepositoryPostgresTestSuite(PostgresTestConnection postgres, ITestOutputHelper? testOutput) : base(testOutput) {
		...
		protected override void ClearRelationships(DbPerson person) {
