...
public class InMemoryRepositoryLifecycleHandlerTests
{
    ...
    public async Task Should_ReturnFalse_When_CheckingExists()
    {
        ...
        services.AddRepositoryContext()
            .AddRepository<TestInMemoryRepository<Person>>(_ => { });
        var provider = services.BuildServiceProvider();
        var handler = new InMemoryRepositoryLifecycleHandler<Person>(provider, NullLogger<InMemoryRepositoryLifecycleHandler<Person>>.Instance);
    ...
    public async Task Should_SeedEntities_When_SeedAsyncCalled()
    {
        ...
        var repository = provider.GetRequiredService<IRepository<Person>>();
