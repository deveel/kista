...
> The legacy `IQueryableRepository`, `IPageableRepository`, and `IFilterableRepository` interfaces were **removed in 1.7.1** and will not compile. If you are upgrading from 1.7.0, see the [Migration from 1.7 guide](../migrating-from-1.7.md) for before/after patterns.
