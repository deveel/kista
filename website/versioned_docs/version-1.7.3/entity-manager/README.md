...
- [Operation Pipeline](operation-pipeline.md) — the extensible interceptor chain for cross-cutting concerns (audit, events, tracing, short-circuit)
- [Soft-Delete Support](../soft-delete.md) — restore, hard-delete, and `DeletedBy` audit stamping through the Entity Manager
