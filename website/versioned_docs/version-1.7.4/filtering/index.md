...
The `Repository<TEntity, TKey>` base class exposes these filtering methods through `protected` members, and consumer code reaches the same surface through extension methods on `IRepository<TEntity>`:
