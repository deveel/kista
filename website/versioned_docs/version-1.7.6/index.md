...
| [_Migrating from 1.7.3_](migrating-from-1.7.3.md) | How to update from 1.7.3 after the cache was aligned to the operation pipeline (`RemoveRangeAsync` behavior change) |
| [_Migrating from 1.7.5_](migrating-from-1.7.5.md) | How to update from 1.7.5 after the owner-scope, IDOR, Dynamic LINQ, `AsNoTracking`, and health-check payload security changes |
